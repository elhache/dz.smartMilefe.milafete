...
public class UserManagementPanelNew extends Composite {
	...
	public UserManagementPanelNew(Composite parent, int style,
		...
		SashForm sashForm = new SashForm(composite_permissions, SWT.NONE);
		FormData fd_sashForm = new FormData();
		fd_sashForm.top = new FormAttachment(btnDetails, 0, SWT.TOP);
		fd_sashForm.left = new FormAttachment(lblAuthorisations, 0, SWT.LEFT);
		sashForm.setLayoutData(fd_sashForm);

		SashForm sashForm_1 = new SashForm(this, SWT.BORDER);
		sashForm_1.setLayoutData(BorderLayout.CENTER);
		sashForm_1.setSashWidth(5);

		Composite composite_list = new Composite(sashForm_1, SWT.BORDER);
		...
		fd_btnSearchbylastname.top = new FormAttachment(btnSearchbyusername, 0, SWT.TOP);
		fd_btnSearchbylastname.left = new FormAttachment(btnSearchbyusername, 6);
		...
		fd_label.bottom = new FormAttachment(btnSearchbyusername, 8, SWT.BOTTOM);
		...
		fd_listUsers.right = new FormAttachment(btnNewUser, 0, SWT.RIGHT);
		fd_listUsers.bottom = new FormAttachment(btnNewUser, -6);
		FormData fd_btnNewUser = new FormData();
		fd_btnNewUser.right = new FormAttachment(100);
		fd_btnNewUser.left = new FormAttachment(0, 5);
																																																								...
																																																								btnAddaction.setText("AddAction");
																																																										...
																																																										btnRemoveaction.setText("RemoveAction");
																																																												...
																																																												btnAddBasket.setText("Add Basket");
																																																														...
																																																														sashForm_1.setWeights(new int[] {246, 587});
		...
		Realm.runWithDefault(SWTObservables.getRealm(display), new Runnable() {
			public void run() {
				try {
					...
					new UserManagementPanelNew(shell, SWT.NONE, appDataManagement);
					shell.pack();
					shell.open();
